/**
 * Aplica columnas de contenido HTML/formulario a DocenteSilabus.
 * Uso: node scripts/apply-docente-silabus-contenido.mjs
 */
import fs from 'fs';
import pg from 'pg';
...
const sql = fs.readFileSync('scripts/migrations/add-docente-silabus-contenido.sql', 'utf8');
...
try {
  ...
  `);
  console.log('Columnas DocenteSilabus:');
