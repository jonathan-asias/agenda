    ...
    <section className="w-full py-16">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <Link
            href="/login"
            className="inline-flex items-center justify-center rounded-full border border-blue-600 px-6 py-3 text-sm font-medium text-blue-700 transition-colors hover:border-blue-700 hover:text-blue-800"
          >
            Iniciar sesión
          </Link>
        </div>
