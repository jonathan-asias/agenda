const benefits = [
  ...
  },
  {
    ...
    description: 'Planes claros y facturación mensual o anual. Pago seguro con Mercado Pago.',
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function BenefitsSection() {
  return (
    <section
      id="benefits"
      className="bg-blue-600 px-4 py-16 sm:px-6 sm:py-24"
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group rounded-2xl border border-white/20 bg-white p-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl sm:p-8"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-600 text-white transition-transform duration-300 group-hover:scale-105">
                {benefit.icon}
              </div>
