...
export default function AddAdministradorModal({
  ...
  return (
    <Modal open={isOpen} onClose={handleClose} title="Agregar administrador" size="xl" className="max-w-4xl">
      <p className="text-sm text-[var(--color-text-secondary)] mb-4">
        Complete la información del nuevo administrador de la institución.
      </p>
