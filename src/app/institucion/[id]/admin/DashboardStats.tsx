...
export default function DashboardStats({ estadisticas, recordatoriosCount = 0 }: DashboardStatsProps) {
  const iconClass = 'w-5 h-5 flex-shrink-0';
  const stats = [
    {
      title: 'Áreas',
      value: estadisticas.areas,
      icon: (
